...
async def test_improved_pdf_report():
    """测试改进后的PDF报告生成功能"""
    ...
    # 创建一些模拟的图表文件路径（实际应用中这些文件应该由generate_charts工具生成）
    chart_files = [
        "./run_workdir/bar_chart_20250917_154122.png",
        "./run_workdir/line_chart_20250917_154122.png"
    ]
    
    # 调用save_pdf_report方法生成PDF报告，包含图表
    print("正在生成改进版PDF报告...")
...
if __name__ == "__main__":
    asyncio.run(test_improved_pdf_report())